...
Here's the function
```{r}
customize_vocano = function(plot_res, positive_color = 'salmon', negative_color = 'royalblue', ns_color = 'gray',  pval_lim = 0.05, positive_LFC_lim = 0.5, negative_LFC_lim = -0.5, contrast_name = c('group1' ,'group2'), labSize = 5, drawConnectors = TRUE  ){
  ...
  keyvals = ifelse( 
  (plot_res$log2FoldChange < negative_LFC_lim & plot_res$pvalue < pval_lim), negative_color, 
  ifelse( (plot_res$log2FoldChange > positive_LFC_lim & plot_res$pvalue < pval_lim), positive_color,
          ns_color))
